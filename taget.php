...
<body>
    ...
    <div class="main-info">
        ...
        <h2>Tider</h2>
        <p>Tider: Tåget startar precis norr om Lundagård kl 13 både lördag och söndag 19-20 maj. Det tar ca två timmar för karnevalståget att ta sig (moturs) runt Lund!</p>
        <p>Datum: 19 maj<br>
            Tid:10.00<br>
