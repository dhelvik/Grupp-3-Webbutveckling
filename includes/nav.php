    ...
    <ul class="phone-bar">
        <li><a href="#"><img src="bilder/mobile-nav-icon.png"></a>
            <ul class="navClass">
                ...
                <?php if ($user != false) {
                    echo '<li><a>'.$user->username .'</a><ul><li><a href="adminVy.php">Karnevalister</a></li><li><a href="addEventInfo.php">Lägg till evenemang</a></li><li><a onclick=document.getElementById("signOut").submit();>Logga ut</a></li></ul></li>';
